...
var attackCooldown = 0 #Cooldown for bro's attacks


const aggro_range = 30
const melee_range = 3  # Distance at which bro uses melee attacks
const ranged_range = 15  # Distance at which bro uses ranged attacks
